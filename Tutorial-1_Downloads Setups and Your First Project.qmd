...
>   packages can removed in the same way i.e. `] remove Plots`  (or `Pkg.remove("Plots")`) will remove the Plots package from your project environment (and its record in the Project.toml and Manifest.toml files)
